...
- MESSAGE_RELAY: מבקשת שתעביר הודעה למספר מסוים — "תכתוב ל-050... ש...", "תענה למספר ... ותגיד לו", "שלח את זה ל-05...". שים לב: זו בקשה לשלוח למספר **בודד**, בשונה מ-FYI_BROADCAST שהוא הפצה לקבוצות.
- GROUP_CREATION: מבקשת ליצור קבוצת וואטסאפ חדשה ולהוסיף אליה רשימת מספרים — "תפתח קבוצה בשם ... ותוסיף את המספרים", "צור קבוצה ל...". בדרך כלל מגיעה יחד עם רשימת מספרים.
- KNOWLEDGE_UPDATE: מבקשת לעדכן את מאגר המידע של הבוט — "להלן מידע חדש", "תעדכן את המאגר", "יש שינוי בלו״ז, תעדכן". שים לב: זה **שונה מ-FYI_BROADCAST** — FYI מופץ לקבוצות, וכאן המידע נשמר במאגר שהבוט עונה ממנו.
