...
const electronAPI: ElectronAPI = {
  ...
  accounts: {
    ...
    reconnect: (id, proxy) => ipcRenderer.invoke('accounts:reconnect', id, proxy),
    resetSession: (id, proxy) => ipcRenderer.invoke('accounts:resetSession', id, proxy),
  ...
  chatbot: {
    ...
    getFyiMessages: () => ipcRenderer.invoke('chatbot:getFyiMessages'),
    sendDigestNow: () => ipcRenderer.invoke('chatbot:sendDigestNow'),
    getKnownContacts: () => ipcRenderer.invoke('chatbot:getKnownContacts'),
    saveKnownContact: (contact, originalPhone) => ipcRenderer.invoke('chatbot:saveKnownContact', contact, originalPhone),
    deleteKnownContact: (phone) => ipcRenderer.invoke('chatbot:deleteKnownContact', phone),
    previewContactImport: (text) => ipcRenderer.invoke('chatbot:previewContactImport', text),
    pickContactFile: () => ipcRenderer.invoke('chatbot:pickContactFile'),
    importKnownContacts: (contacts) => ipcRenderer.invoke('chatbot:importKnownContacts', contacts),
